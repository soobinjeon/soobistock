...
namespace SoobiStock.Yuanta
{
    public class CommDef
    {
        ...
        */
        ...
        public static int ERROR_CERT_PASSWORD_SHORT = 116;		// 공인인증서 비밀번호가 최소길이보다 짧습니다.
        public static int ERROR_ID_SHORT = 117;		// 로그인 아이디가 최소길이보다 짧습니다.
        public static int ERROR_ID_PASSWORD_SHORT = 118;		// 로그인 비밀번호가 최소길이보다 짧습니다.
        public static int ERROR_CERT_DIFF_CERT_SELECT = 119;		// 공인인증서 DN이 일치하지 않습니다.
        ...
        public static int ERROR_REQUEST_SEC_LIMIT_OVER = 211;		// 요청 카운트 5초당 제한을 초과하였습니다.
        public static int ERROR_REQUEST_MIN_LIMIT_OVER = 212;		// 요청 카운트 분당 제한을 초과하였습니다.
        public static int ERROR_REQUEST_HOUR_LIMIT_OVER = 213;		// 요청 카운트 시간당 제한을 초과하였습니다.
